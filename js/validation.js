var welcome = new Audio("js/welcome.mp3");
var notPass = new Audio("js/gandalf.mp3");
var gandalf = document.querySelectorAll("img");

function hello(){
    for (var i = 0; i < gandalf.length; i++){
        gandalf[i].style.display = "none";
    }
    welcome.play();
}
...
title.innerText = ("Validator 3000");
...
userAge.setAttribute('placeholder', "How old are you? : 30;");

var userName = document.createElement("input");
userName.setAttribute('type', "text");
userName.setAttribute('name', "username");
userName.setAttribute('placeholder', "Create your super nickname : user_Xander;");

var date = document.createElement("input");
date.setAttribute('type', "text");
date.setAttribute('name', "date");
date.setAttribute('placeholder', "Current date : format dd/mm/yyyy;");
